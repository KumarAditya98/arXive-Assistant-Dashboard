...
os.environ['HUGGINGFACEHUB_API_TOKEN'] = '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'

token = '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'

def genai(retriever, query, context):
    # repo_id = 'lmsys/fastchat-t5-3b-v1.0'
    repo_id = 'google/flan-t5-large'
    llm = HuggingFaceHub(huggingfacehub_api_token= token,
                         repo_id=repo_id,
